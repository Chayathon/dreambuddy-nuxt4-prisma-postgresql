<template>
    <div class="space-y-6">
        ...
        >
            ...
            <!-- Password -->
            <UFormField
                :label="String($t('auth.register.password'))"
                name="password"
            >
                <UInput
                    ...
                    type="password"
                    :placeholder="
                        String($t('auth.register.passwordPlaceholder'))
                    "
                    size="lg"
            ...
            >
                <UInput
                    ...
                    type="password"
                    :placeholder="
                        String($t('auth.register.confirmPasswordPlaceholder'))
                    "
                    size="lg"
                    autocomplete="new-password"
                    class="w-full"
...
const schema = z
    .object({
        name: z
            ...
            .min(
                1,
                String($t("auth.register.nameRequired") || "Name is required")
            ),
        username: z
            .string()
            .min(
    ...
    try {
        ...
        toast.add({
            ...
            description:
                ...
                error.message ||
                String(
                    $t("auth.register.errorMessage") || "Registration failed"
                ),
            color: "error",
        });
    } finally {

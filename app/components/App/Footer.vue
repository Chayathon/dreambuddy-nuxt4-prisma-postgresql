<template>
    ...
    >
        <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <!-- Main Footer Content -->
            <div
                class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8 mb-8"
            >
                <!-- Brand Column -->
                <div class="col-span-2">
                    <div class="flex items-center space-x-2 mb-4">
                        ...
                        />
                        <span
                            class="text-xl font-bold bg-linear-to-r from-primary-500 to-purple-600 bg-clip-text text-transparent"
                        >
                            DreamBuddy
                        </span>
                    </div>
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        <li
                            v-for="(link, index) in footerLinks.product"
                            :key="index"
                        >
                            <a
                                :href="link.href"
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        <li
                            v-for="(link, index) in footerLinks.company"
                            :key="index"
                        >
                            <a
                                :href="link.href"
                ...
                <div class="col-span-2 md:col-span-4 lg:col-span-1">
                    ...
                    <div class="flex gap-2">
                        <input
                            type="email"
                            :placeholder="
                                String($t('footer.newsletter.placeholder'))
                            "
